...
def get_screen_details():
    ...
    for i, screen in enumerate(sorted_screens):
        ...
        if screen.is_primary:
            ...
            position = "Secondary"
        screen_info = (
            f"Screen {i + 1}: {screen.width}x{screen.height}, {layout}, {position}"
        )
...
class ComputerTool(BaseAnthropicTool):
        ...
        if system == "Windows":
                ...
                screens.append(
                    {
                        ...
                        "is_primary": Quartz.CGDisplayIsMain(
                            display_id
            ...
            try:
                ...
                bbox = (
                    ...
                    width,
                    height,
                )  # Assuming single primary screen for simplicity
        ...
        **kwargs,
        ...
        if action in ("key", "type"):
            ...
            if action == "key":
                ...
                pyautogui.typewrite(
                    text, interval=TYPING_DELAY_MS / 1000
    ...
    async def screenshot(self):
        ...
        screenshot = screenshot.resize(
            (self.target_dimension["width"], self.target_dimension["height"])
        )
        ...
        if platform.system() == "Windows":
            ...
            if self.selected_screen is None:
                primary_monitor = next(
                    (m for m in get_monitors() if m.is_primary), None
                )
            ...
            if self.selected_screen is None:
                ...
                primary_monitor = next(
                    (screen for screen in screens if screen["is_primary"]), None
                )
                if primary_monitor:
                    return primary_monitor["width"], primary_monitor["height"]
                else:
